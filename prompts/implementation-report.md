...
only `.uncle/docs/IMPLEMENTATION_NOTES.md`, the worker logs and handoffs under
`.uncle/workflow`, and the approved verification commands in
`.uncle/docs/UPDATED_PROJECT_PLAN.md` as needed to identify evidence that already exists.

Replace `.uncle/docs/AUTOMATED_TEST_REPORT.md` with the canonical report required by the
...
Preserve all existing worker handoffs in `.uncle/docs/IMPLEMENTATION_NOTES.md`. Add a short
