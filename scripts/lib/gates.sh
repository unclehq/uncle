...
DOC_STAGES=" requirements project-plan updated-plan preflight implementation execute-checklist change-plan updated-change-plan adversarial-review test-review test-review-investigate manual-checklist manual-checklist-base manual-checklist-delta final-audit "
