...
for stage in requirements preflight implementation execute-checklist final-audit; do
    rm -f "$UNCLE_CONFIG"
    [[ "$(uncle_stage_network "$stage")" == false ]]
